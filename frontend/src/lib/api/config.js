...
export const API_ENDPOINTS = {
  ...
  RESTAURANT: {
    ...
    SEARCH_SUGGESTIONS: '/restaurant/search-suggestions',
  ...
  DELIVERY: {
    ...
    WALLET_DEPOSIT_CASH: '/delivery/wallet/deposit/cash',
  ...
  ADMIN: {
    ...
    RESTAURANT_SEND_EMAIL: '/admin/restaurants/:id/send-email',
    ...
    DELIVERY_BOY_AGREEMENT: '/admin/delivery-boy-agreement',
    DELIVERY_BOY_AGREEMENT_PUBLIC: '/delivery-boy-agreement/public',
    DELIVERY_BOY_TERMS: '/admin/delivery-boy-terms',
    DELIVERY_BOY_TERMS_PUBLIC: '/delivery-boy-terms/public',
    REFUND: '/admin/refund',
    ...
    ORDER_REJECT_RESTAURANT: '/admin/orders/:orderId/reject-restaurant',
