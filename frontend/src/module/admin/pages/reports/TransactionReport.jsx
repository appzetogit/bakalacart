...
export default function TransactionReport() {
  ...
  const viewType = searchParams.get('view') || 'gross' // 'gross' or 'total'
      ...
      <div className="w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
          ...
          <div className="space-y-3">
            {/* Primary Highlight Card (Dynamic based on dashboard click) */}
            {viewType === 'total' ? (
              <div className="rounded-lg shadow-sm border border-slate-200 p-4 bg-blue-50/50">
                <div className="relative mb-3 flex justify-center">
                  <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center">
                    <img src={adminEarningIcon} alt="Total Revenue" className="w-12 h-12" />
                  </div>
                ...
                <div className="text-center">
                  <p className="text-xl font-bold text-blue-600 mb-1">{formatCurrency(summary.adminEarning)}</p>
                  <p className="text-sm text-slate-600 leading-tight">Total Revenue (Admin Earning)</p>
                </div>
              </div>
            ) : (
              <div className="rounded-lg shadow-sm border border-slate-200 p-4" style={{ backgroundColor: '#f1f5f9' }}>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-slate-600 leading-tight">Gross Revenue (Completed Transaction)</p>
                </div>
              </div>
            )}
          ...
          <div className="space-y-3">
            {/* View-adaptive Secondary Metric Card */}
            {viewType === 'total' ? (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center">
                      <img src={completedIcon} alt="Gross Revenue" className="w-6 h-6" />
                    </div>
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-semibold text-slate-900">Gross Revenue</p>
                      <div className="w-5 h-5 rounded-full bg-green-500 flex items-center justify-center">
                         <Info className="w-3 h-3 text-white" />
                      </div>
                    </div>
                  </div>
                  <p className="text-base font-bold text-slate-900">{formatCurrency(summary.completedTransaction)}</p>
                </div>
              </div>
            ) : (
              <div className="rounded-lg shadow-sm border border-slate-200 p-3" style={{ backgroundColor: '#f1f5f9' }}>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
            <h2 className="text-base font-bold text-slate-900">Order Transactions {totalRecords}</h2>
