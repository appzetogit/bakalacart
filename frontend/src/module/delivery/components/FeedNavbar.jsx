  ...
  return (
    ...
    <div className={`bg-white px-4 py-3 flex items-center justify-between sticky top-0 z-50 border-b border-gray-200 ${className}`}>
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <svg className="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5} aria-hidden="true">
        ...
        >
          <HelpCircle className="w-5 h-5 text-gray-700" aria-hidden="true" />
        </button>

        {/* Profile */}
        <button onClick={handleProfileClick} className="w-9 h-9 rounded-full overflow-hidden ring-2 ring-gray-300 flex items-center justify-center bg-gray-200" title="Profile" aria-label="Profile menu">
