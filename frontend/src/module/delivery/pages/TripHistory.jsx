...
export default function TripHistory() {
  ...
  useEffect(() => {
    const isUIOpen = showBonusModal || showDatePicker || showTripTypePicker;
    ...
    const handlePopState = () => {
      if (isUIOpen) {
        ...
        setShowDatePicker(false);
        setShowTripTypePicker(false);
        console.log('🔙 Back button detected: Closing TripHistory UI elements');
      }
    };

    window.addEventListener('popstate', handlePopState);
    return () => window.removeEventListener('popstate', handlePopState);
  }, [showBonusModal, showDatePicker, showTripTypePicker]);
