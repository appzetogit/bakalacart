...
import deliveryBoyAgreementPublicRoutes from './modules/admin/routes/deliveryBoyAgreementPublicRoutes.js';
import deliveryBoyTermsPublicRoutes from './modules/admin/routes/deliveryBoyTermsPublicRoutes.js';
...
import updatePagePublicRoutes from './modules/admin/routes/updatePagePublicRoutes.js';
...
const allowedSocketOrigins = [
  ...
  'https://bakalaa.com',
  'http://bakalaa.com',
  'https://www.bakalaa.com',
  'http://www.bakalaa.com',
...
app.use('/api', deliveryBoyAgreementPublicRoutes);
app.use('/api', deliveryBoyTermsPublicRoutes);
...
app.use('/api', updatePagePublicRoutes);
